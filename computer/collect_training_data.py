...
class CollectTrainingData(object):
    ...
    def __init__(self):
        ...
        # GPIO cmd as a client
        self.gpio_socket.connect(('172.24.1.1', 8002))
                    ...
                    for event in pygame.event.get():
                        if event.type == KEYDOWN:
                            ...
                            # simple orders
                                ...
                                print("Right")
                                self.gpio_socket.sendall(right)
                                ...
                                print 'exit'
                                self.gpio_socket.sendall(clean)
